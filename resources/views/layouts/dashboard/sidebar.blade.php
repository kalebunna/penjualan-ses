    ...
    <div class="sidebar-wrapper active">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{route('dashboard')}}" class="d-flex align-items-center text-decoration-none">
                        <img src="{{ asset('logo.jpeg') }}" alt="BAINA" style="height: 50px; width: auto;" class="me-2">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{request()->path() === 'dashboard/penjualan' ? 'active' : ''}}">
                    <a href="{{route('penjualan.index')}}" class="sidebar-link">
                        <i class="bi bi-stack"></i>
                        <span>Data Penjualan</span>
                    </a>
                </li>
                <li class="sidebar-item {{request()->path() === 'dashboard/parameters' ? 'active': ''}}">
                    <a href="{{route('parameter.index')}}" class="sidebar-link">
